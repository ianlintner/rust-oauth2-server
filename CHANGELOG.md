...
- [WIP] Update documentation with agent prompts and technical instructions (#125)
- reconcile CHANGELOG — 2026-W16 (#127)
- [WIP] Update skills and custom agents for current AI tooling (#132)
- upgrade caretaker to v0.5.2 (#135)
- [WIP] Fix CI failure on `main` for build and deploy documentation (#139)
...
- upgrade caretaker from v0.6.5 to v0.7.2 (#151) (#159)
- fix Main (#160)
