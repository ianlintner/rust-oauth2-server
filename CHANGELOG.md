...
- docs: reconcile CHANGELOG — 2026-W16, add expanded entries for PRs #115–#117 (#120)
- docs: update `CLAUDE.md` with Copilot coding agent instructions, RFC compliance invariants, and project structure reference for AI agent use (#125)
- docs: reconcile CHANGELOG — 2026-W16, consolidate all duplicate sections and expand remaining cryptic titles (#127)
