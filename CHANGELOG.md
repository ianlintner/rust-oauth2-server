...
- chore: improve `CLAUDE.md` with behavioral guidelines for AI coding agents (Think Before Coding, Simplicity First, Surgical Changes, Goal-Driven Execution) (#104)
...
- docs: update agent instruction files with detailed prompts and technical documentation for Copilot coding agent (#125)
- docs: reconcile CHANGELOG — 2026-W16 (#127)
- chore: update custom agent skills and configurations for current AI tooling (#132)
- chore: upgrade caretaker to v0.5.2 (#135)
